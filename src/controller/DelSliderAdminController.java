...
public class DelSliderAdminController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DelSliderAdminController() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (user.getIdCapbac() == 1) {
			...
			if (sliderDAO.delItem(idS1) > 0) {
				response.sendRedirect(request.getContextPath() + "/admin/slider?msg=3");
				return;
			} else {
