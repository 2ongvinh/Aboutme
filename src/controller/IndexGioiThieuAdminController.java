...
public class IndexGioiThieuAdminController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public IndexGioiThieuAdminController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Gioithieu> listGT = gioithieuDAO.getItems();
		request.setAttribute("listGT", listGT);
		
		RequestDispatcher rd = request.getRequestDispatcher("/admin/indexGioithieu.jsp");
