  ...
  <head>
   ...
   %>
    <%@include file="/admin/inc/header.jsp"%>
        ...
        <div>
       		<h2 class="margin-bottom-10" align="center">Danh Ngôn</h2>
         </div>
        <div class="templatemo-flex-row flex-content-row">
        <%if(objUser.getIdCapbac()==1){ %>
            <div class="templatemo-content-widget no-padding">
                       <a href="<%=request.getContextPath() %>/admin/themdanhngon" class="templatemo-add-btn">Thêm Danh Ngôn</a>
            </div>
            <%} %>
        </div>
         <div class="templatemo-content-widget no-padding" >
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    <td ><a href="" class="white-text templatemo-sort-by">Danh Ngôn<span class="caret"></span></a></td>
                ...
                %>
                  ...
                  <tr>
                    <td><%=objDN.getIdDN() %></td>
                    <td><%=objDN.getNoidungDN() %></td>
                    <td><%=objDN.getTacgiaDN() %></td>
                    <td><img src="<%=request.getContextPath() %>/files/<%=objDN.getHinhanhDN() %>" width="150px" height="100px"/></td>
                    <%if(objUser.getIdCapbac()==1){ %>
                    <td><a href="<%=request.getContextPath() %>/admin/suadanhngon?id=<%=objDN.getIdDN() %>" class="templatemo-edit-btn">Edit</a></td>
						<td><a
							href="<%=request.getContextPath() %>/admin/xoadanhngon?id=<%=objDN.getIdDN() %>" class="templatemo-edit-btn" onclick="return getThongBao()">Delete</a></td>
                  <%} %>
                  </tr>
                  <%} %>
                </tbody>
           ...
           <div class="pagination-wrap">
            <ul class="pagination">
              <%
				...
				%> 
			<li <%=cl %>><a href="<%=request.getContextPath()%>/admin/danhngon?page=<%=i%>"><%=i %></a></li>
			
			<%} %>
              <li>
                <a href="<%=request.getContextPath()%>/admin/danhngon?page=<%=current_page+1%>" aria-label="Next">
