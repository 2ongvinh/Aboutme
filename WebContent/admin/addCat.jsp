  ...
  <head>
    ...
    <%@include file="/admin/inc/header.jsp"%>
		...
		if(request.getParameter("msg")!=null){
            ...
            <form action="<%=request.getContextPath() %>/admin/xl-themdanhmuc"  method="post" class="formDanhMuc">
              
             <div class="row form-group">
                <div class="col-lg-12 form-group">                  
                    <label for="inputNote">Tên Danh Mục (*)</label>
                    <input type="text" class="form-control" id="inputNote" name="tendanhmuc">  
                </div>
              </div>
