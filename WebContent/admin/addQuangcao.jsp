    ...
    <%@include file="/admin/inc/header.jsp"%>
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form  enctype="multipart/form-data" action="<%=request.getContextPath() %>/admin/xl-themquangcao"  method="post" class="formQuangCao">
              
             <div class="row form-group">
                <div class="col-lg-12 form-group">                  
                    <label for="inputNote">Tên Quảng Cáo</label>
                    <input type="text" class="form-control" id="" name="tenquangcao">                  
                </div>
              </div>
              ...
              $(document).ready(function() {
					$('.formQuangCao').validate({
						...
						messages : {
							tenquangcao : {
								required : "Vui lòng nhập tên quảng cáo",
							},
							link : {
