    ...
    <%@include file="/admin/inc/header.jsp"%>
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form enctype="multipart/form-data" action="<%=request.getContextPath() %>/admin/xl-themslider"  method="post" class="formSlider">
              
             <div class="row form-group">
                <div class="col-lg-12 form-group">                  
                    <label for="inputNote">Tên Slider</label>
                    <input type="text" class="form-control" id="" name="tenslider" >                  
                </div>
              </div>
              ...
              $(document).ready(function() {
					$('.formSlider').validate({
						...
						messages : {
							tenslider : {
								required : "Vui lòng nhập tên slider",
							},
							mota : {
